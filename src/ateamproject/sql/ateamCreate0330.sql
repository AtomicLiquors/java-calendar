...
-- 테이블 데이터 mydb.dday:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 mydb.member:~3 rows (대략적) 내보내기
...
INSERT INTO `reply` (`mb_id`, `sc_id`, `rp_id`, `rp_content`, `rp_date`) VALUES
	('vadmin', 1, 1, '테스트용 코멘트입니다.', '2022-03-30');
...
INSERT INTO `sched` (`sc_id`, `sc_startdate`, `sc_title`, `sc_enddate`, `sc_content`, `sc_isdone`, `sc_privacy`, `sc_priority`, `sc_color`) VALUES
	(1, '2022-03-25', '일정 제목', '2022-03-30', '일정 내용', NULL, NULL, NULL, NULL),
	(17, '2022-04-01', '새 일정 제목', '2022-04-01', 'Dday 테스트용 일정', 0, NULL, 0, NULL);
